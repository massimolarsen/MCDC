...
m_al7075  = mcdc.MaterialMG(name="Al7075",  capture=np.array([0.02815]), scatter=np.array([[0.01408]]))
m_al6061  = mcdc.MaterialMG(name="Al6061",  capture=np.array([0.02700]), scatter=np.array([[0.01350]]))
m_epoxy   = mcdc.MaterialMG(name="Epoxy",   capture=np.array([0.01200]), scatter=np.array([[0.00600]]))
m_silicon = mcdc.MaterialMG(name="Silicon", capture=np.array([0.02330]), scatter=np.array([[0.01165]]))
m_licoo2  = mcdc.MaterialMG(name="LiCoO2",  capture=np.array([0.05030]), scatter=np.array([[0.02515]]))
m_copper  = mcdc.MaterialMG(name="Copper",  capture=np.array([0.08960]), scatter=np.array([[0.04480]]))
m_void    = mcdc.MaterialMG(name="Void",    capture=np.array([0.00000]), scatter=np.array([[0.00000]]))
...
# =============================================================================
# SOURCE
# Isotropic source distributed across all six boundary-cube faces.
# =============================================================================
