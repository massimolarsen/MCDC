...
# Element compositions are atom densities in atoms/barn-cm.
# =============================================================================
...
m_al7075 = mcdc.Material(
    name="Al7075",
    element_composition={
        "Al": 0.056445980580537,
        "Zn": 0.0013235134207385,
        "Mg": 0.0021165961369498,
        "Cu": 0.0005378141989737,
    },
)
...
m_al6061 = mcdc.Material(
    name="Al6061",
    element_composition={
        "Al": 0.059057360465045,
        "Mg": 0.00081349602416576,
...
m_silicon = mcdc.Material(name="Silicon", element_composition={"Si": 0.050132618436459})
# LiCoO2 proxy, rho=5.05 g/cm3, wt%: 6.661 Li-7, 60.551 Co-59, 32.788 O-16.
m_licoo2 = mcdc.Material(
    name="LiCoO2_proxy",
    element_composition={
        "Li": 0.028874848294873,
        "Co": 0.031246477802075,
        "O": 0.062341083116754,
    },
)
...
m_copper = mcdc.Material(
    name="Copper",
    element_composition={"Cu": 0.084912264300285},
)
...
# 1. 500 km circular orbit
# 2. 90° inclination
# 3. solar minimum
# 4. 0.04–7 MeV
source_spectrum_path = EXAMPLE_DIR / "ae8_7MeV.csv"
