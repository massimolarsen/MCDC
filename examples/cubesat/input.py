...
m_silicon = mcdc.Material(
    name="Silicon", nuclide_composition={"Si28": 0.050132618436459}
)
...
mcdc.Cell(region=void_region, fill=m_void)
...
mcdc.Tally(
    name="EPS SV energy deposition",
    cell=eps_sv,
    scores=["energy_deposition"],
    energy=ENERGY_BINS_EV,
)
mcdc.Tally(
    name="ADCS SV energy deposition",
    cell=adcs_sv,
    scores=["energy_deposition"],
    energy=ENERGY_BINS_EV,
)
mcdc.Tally(
    name="Comms SV energy deposition",
    cell=comms_sv,
    scores=["energy_deposition"],
    energy=ENERGY_BINS_EV,
)
