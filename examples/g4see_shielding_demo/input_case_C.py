...
# Case C is one of the primary coupling cases because it uses volumetric
...
mcdc.settings.output_name = "case_C_box_wall_vol_source"
...
#geo_viewer_3d(simulation=simulation, save_animation_path=str(Path(__file__).with_name("case_C_geometry.gif")))
