"""Static trimesh-based geometry visualization helpers for MCDC."""
...
def geo_viewer_3d_static_trimesh(
    simulation,
    ...
    if save_animation_path:
        print(f"[trimesh] Saving single-frame animation to {save_animation_path}")
