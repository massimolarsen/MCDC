...
surface_crossing_tally = into_dtype([
    ...
    ('surface_mesh_Nu', int64),
    ('surface_mesh_Nv', int64),
    ('surface_mesh_stride_face', int64),
    ('surface_mesh_stride_u', int64),
    ('surface_mesh_stride_v', int64),
    ('surface_mesh_xmin_surface_ID', int64),
    ('surface_mesh_xmax_surface_ID', int64),
    ('surface_mesh_ymin_surface_ID', int64),
    ('surface_mesh_ymax_surface_ID', int64),
    ('surface_mesh_zmin_surface_ID', int64),
    ('surface_mesh_zmax_surface_ID', int64),
    ('surface_mesh_x_min', float64),
    ('surface_mesh_x_max', float64),
    ('surface_mesh_y_min', float64),
    ('surface_mesh_y_max', float64),
    ('surface_mesh_z_min', float64),
    ('surface_mesh_z_max', float64),
    ('ID', int64),
    ('parent_ID', int64),
])
